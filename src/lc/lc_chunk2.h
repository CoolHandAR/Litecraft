...
typedef struct
{
	...
	int opaque_index; //opaque vertex buffer index
	int transparent_index; //transparent vertex buffer index
	int water_index; //water vertex buffer index
...
GeneratedChunkVerticesResult* LC_Chunk_GenerateVertices3(LC_Chunk* const chunk);
