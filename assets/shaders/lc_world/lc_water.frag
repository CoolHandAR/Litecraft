...
void main()
{
    ...
    vec2 distortionCoords = texture(dudv_map, vec2(vs_in.TexCoords.x + scene.time * 0.05, vs_in.TexCoords.y)).rg;
    distortionCoords = distortionCoords + vec2(distortionCoords.x, distortionCoords.y + scene.time * 0.05);
